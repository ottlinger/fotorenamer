...
public final class RemoveExifPrefixRenamer implements Runnable {
    ...
    public void run() {
        ...
        String statusMessage = switch (this.done.get()) {
            case 0 ->
                    getParameterizedBundleString("fotorenamer.ui.rename.success.message.none", this.currentDirectory.getName());
            case 1 ->
                    getParameterizedBundleString("fotorenamer.ui.rename.success.message.one", this.currentDirectory.getName());
            default ->
                    getParameterizedBundleString("fotorenamer.ui.rename.success.message", this.done, this.listOfFiles.size(), this.currentDirectory.getName());
        };
