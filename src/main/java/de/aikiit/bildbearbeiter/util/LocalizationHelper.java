...
public final class LocalizationHelper {
    ...
    /**
     * ResourceBundle used for fotorenamer. Currently it's static and German only.
     */
    private static final ResourceBundle BUNDLE = ResourceBundle.getBundle("fotorenamer", Locale.GERMAN);


    /**
     * Use a German message format as well to process parameters to property messages.
     */
     ...
     *
     * @param key Key to retrieve from the bundle, e.g. <i>fotorenamer.foo.title</i>
    ...
    /**
     * Helper function to retrieve a given key from the underlying resource bundle while
